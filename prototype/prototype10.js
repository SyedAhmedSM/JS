...
o Example: If a product costs $1000 and a 10% discount is applied, the new price
should be $900.
2. purchase(quantity)
...
o Example: If 5 items are in stock and the user buys 3, the new stock should be 2.
...
console.log(product.purchase(3)); // 2
console.log(product.stock); // 2
console.log(product.purchase(3)); // Not enough stock
console.log(product.stock); // 2
